...
## Migration from Original React Project

### Sprint 1: Core API Routes
- [x] Migrate templates router (CRUD operations)
- [x] Migrate trainers router (directory, approval)
- [x] Migrate invitations router (send, accept, revoke)
- [x] Migrate joinRequests router (create, approve, reject)
- [x] Migrate bundleApproval router (approve, reject, request changes)
