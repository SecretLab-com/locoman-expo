/**
 * Portal Runtime - Communication layer between Expo web app and parent container
 *
 * Simplified flow:
 * 1. initPortalRuntime() called
...
const log = (msg: string) => {
  ...
  console.log(`[PortalRuntime ${ts}] ${msg}`);
};
...
/**
 * Initialize Portal Runtime - just notifies parent that app is ready
 */
