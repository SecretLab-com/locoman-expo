    ...
    <ScreenContainer>
      ...
      <View className="px-4 pt-2 pb-4">
        ...
        <View className="flex-row bg-surface rounded-xl p-1 border border-border">
          ...
          >
            <Text className={`text-center font-medium ${viewMode === "bundles" ? "text-white" : "text-muted"}`}>
              Bundles
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            className={`flex-1 py-2 rounded-lg ${viewMode === "trainers" ? "bg-primary" : ""}`}
            onPress={() => {
              setViewMode("trainers");
              router.push("/my-trainers/find" as any);
            }}
          >
            <Text className={`text-center font-medium ${viewMode === "trainers" ? "text-white" : "text-muted"}`}>
              Trainers
            </Text>
          </TouchableOpacity>
        </View>
